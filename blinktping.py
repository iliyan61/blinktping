...
down_counters = [0] * 8
DOWN_THRESHOLD = 5  # Number of cycles a host must be down before notifying
...
def update_host_status():
    while True:
        for x in range(8):
            ...
            set_pixel(x, 0, 0, 5)  # Light LED to indicate checking
            show()
